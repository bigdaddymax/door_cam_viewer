...
while true; do
  ...
  ffmpeg -loglevel error -timeout 5000000 -rtsp_transport tcp -fflags nobuffer -flags low_delay -probesize 32 -analyzeduration 0 -i "$RTSP_URL" -vf "scale=480:320" -q:v 8 -r 15 -tune zerolatency -preset ultrafast -update 1 -y /tmp/frame.jpg
